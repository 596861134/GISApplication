...
import com.gis.common.dialog.impl.MessageCommonDialog;
...
public final class PermissionInterceptor implements OnPermissionInterceptor {
    ...
    public PermissionInterceptor(Boolean isGlobalInit) {
        this(isGlobalInit, null);
    }

    public PermissionInterceptor(Boolean isGlobalInit, @Nullable String permissionDescription) {
    ...
    public void launchPermissionRequest(@NonNull Activity activity, @NonNull List<String> allPermissions, @Nullable OnPermissionCallback callback) {
        ...
        if (showPopupWindow) {
            ...
            new MessageCommonDialog.Builder(activity)
                    .setTitle(ContextCompat.getString(activity, R.string.common_permission_description_title))
                    .setTips(mPermissionDescription, true)
                    .setCancelText(ContextCompat.getString(activity, R.string.common_permission_denied))
                    .setConformText(ContextCompat.getString(activity, R.string.common_permission_granted))
                    .setCancelListener(() -> {
                        if (callback == null) {
                            return;
                        }
    ...
    private void showPermissionSettingDialog(Activity activity, List<String> allPermissions,
        ...
        new MessageCommonDialog.Builder(activity)
                .setTitle(ContextCompat.getString(activity, R.string.common_permission_alert))
                .setTips(message, true)
                .setCancelText(ContextCompat.getString(activity, R.string.common_permission_denied))
                .setConformText(ContextCompat.getString(activity, R.string.common_permission_goto_setting_page))
                .setConformListener(() -> {
