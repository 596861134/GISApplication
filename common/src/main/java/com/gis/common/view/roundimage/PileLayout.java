 ...
 *
 * 2.创建item layout文件 item_study_reach_praise.xml
 * <com.gis.common.view.roundimage.roundimage.CircleImageView xmlns:android="http://schemas.android.com/apk/res/android"
 ...
 *
 * 3.使用
 * private fun buildImageView(url: Any) {
 *     val imageView: CircleImageView = LayoutInflater.from(context).inflate(R.layout.item_study_reach_praise, mPileLayout, false) as CircleImageView
