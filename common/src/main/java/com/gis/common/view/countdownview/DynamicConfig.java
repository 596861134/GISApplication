package com.gis.common.view.countdownview;
...
public class DynamicConfig {
    ...
    public static class Builder {
        ...
        private void checkData() {
            if (null != timeTextSize && timeTextSize <= 0) {
                timeTextSize = null;
            }

            if (null != suffixTextSize && suffixTextSize <= 0) {
                suffixTextSize = null;
            }
            ...
            if (null != suffixGravity && (suffixGravity < 0 || suffixGravity > 2)) {
                suffixGravity = null;
            }
        }
