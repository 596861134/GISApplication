 ...
 *    desc   : 崩溃捕捉界面
 */
class CrashActivity : BaseViewModelActivity<BaseLayoutViewModel, CrashActivityBinding>(R.layout.crash_activity, BaseLayoutViewModel::class.java) {
    ...
    private val titleView: TextView? by lazy { mBinding.tvCrashTitle }
    private val drawerLayout: DrawerLayout? by lazy { mBinding.dlCrashDrawer }
